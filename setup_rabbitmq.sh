...
curl -i -u $USER_PASSWORD -H "content-type:application/json" \
    -XPUT -d'{"durable":true,"arguments":{"x-dead-letter-exchange":"update_status_instance_exchange_dlq", "x-dead-letter-routing-key": "update_status_routing_key_dlq"}}' \
