...
const startApp = async () => {
    ...
    if (!sessionName) {
        throw new Error("You need specific instance id. For example: npm run start:dev --instance=instance_id or pm2 start 'npm run start' --name='bot_name_here' -- --instance=instance_id_here")
    }
